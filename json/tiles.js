...
var getEntityDefs = function() {
  return {
    ...
    "actorShield"         : { uiName: "Shield",         type : "Shield",    sprite : "spriteShield",          loot : true },
    "actorWand"           : { uiName: "Wand",           type : "Wand",      sprite : "spriteWand",            loot : true },
    "actorCross"          : { uiName: "Cross",          type : "Cross",     sprite : "spriteCross",           loot : true },
    "actorSword"          : { uiName: "Sword",          type : "Sword",     sprite : "spriteSword",           loot : true },
    "actorMeat"           : { uiName: "Meat",           type : "Meat",      sprite : "spriteMeat",            loot : true },
    "actorGoldChest"      : { uiName: "Gold Chest",     type : "GoldChest", sprite : "spriteGoldChest",       loot : true },
    "actorGoldBars"       : { uiName: "Gold Pile",      type : "GoldBars",  sprite : "spriteGoldBars",        loot : true },
    "actorSkull"          : { uiName: "Skull",          type : "Skull",     sprite : "spriteSkull",           loot : true },
    "actorGrate"          : { uiName: "Grate",          type : "Grate",     sprite : "spriteGrate",           loot : true },
    "actorCircle"         : { uiName: "Circle",         type : "Circle",    sprite : "spriteCircle",          loot : true },
